...
```python
Goodvibes.py [-q grimme/truhlar] [-f cutoff_freq] [-t temperature] [-c concentration] [-v scalefactor] [-ti t_initial, t_final, step] [-ci c_initial, c_final, step]) [-s solvent name] <gaussian_output_file(s)>
```
