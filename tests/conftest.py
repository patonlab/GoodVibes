...
# doesn't crash" sweep — all non-error, non-broken files. Excluded:
#   - error files (14, 17, 51-60) — handled by ORCA5_ERROR_FILES below
#   - 07_neon_atom_with_freq.out — source file contains corrupted bytes
#     mid-stream (UnicodeDecodeError); needs to be regenerated
#   - 42_dmso_linked_cpcm_gasfreq.out — accidentally an ORCA 6 file in the
#     orca5 directory on the server
#   - 46_ts_neb_claisen_rearrangement.out — NEB-TS hit MaxIter, no thermo
