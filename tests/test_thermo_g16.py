...
@pytest.mark.parametrize("filename, expected_energy", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.145434),
...
@pytest.mark.parametrize("filename, expected_zpe, scale", [
    ...
    ('03_acetone_linked_opt_freq.log', 0.078728, 1.0),
    ...
    ('13_formaldehyde_tddft_s1.log', 0.021740, 1.0),
    ('15_methanol_oniom_qmmm.log', 0.048069, 1.0),
    ('16_o2_superoxide_anion.log', 0.002650, 1.0),
    ('17_iron_complex_quintet.log', 0.034864, 1.0),
    ('18_propane_linked_composite_dh.log', 0.103557, 1.0),
    ('19_acetic_acid_smd_dmso.log', 0.060971, 1.0),
    ('21_naphthalene_pm7_semiempirical.log', 0.106397, 1.0),
    ('22_hcn_linear_freq_noraman.log', 0.016660, 1.0),
    ('24_iodobenzene_genecp_sdd.log', 0.089780, 1.0),
    ('25_pd_complex_genecp_def2.log', 0.153460, 1.0),
    ('26_pt_complex_genecp_3zone.log', 0.059735, 1.0),
    ('27_custom_functional_iop_b20lyp.log', 0.076136, 1.0),
    ('28_pyridine_smd_acetonitrile_wb97xd.log', 0.089313, 1.0),
    ('29_aniline_cpcm_chloroform.log', 0.098079, 1.0),
    ('30_phenol_smd_thf_pbe0_d3bj.log', 0.104037, 1.0),
    ('31_methylammonium_cpcm_water.log', 0.078862, 1.0),
    ('32_cyclohexane_tpss_meta_gga.log', 0.167579, 1.0),
    ('33_methanol_pbepbe_gga.log', 0.049095, 1.0),
    ...
    ('38_naphthalene_scsmp2.log', 0.175670, 1.0),
    ...
    ('42_dmso_linked_cpcm_gasfreq.log', 0.076748, 1.0),
    ('43_dmabn_bhandhlyp_chargetransfer.log', 0.151294, 1.0),
    ...
    ('47_ts_e2_elimination_ethylchloride.log', 0.075555, 1.0),
    ('48_ts_nh3_umbrella_inversion.log', 0.033320, 1.0),
    ('49_ts_oh_abstraction_methane.log', 0.053403, 1.0),
    ('51_err_scf_convergence_fe_complex.log', 0.198980, 1.0),
    ('58_err_linear_bend_formBX.log', 0.059447, 1.0),
    ('59_err_basis_linear_dependency.log', 0.003255, 1.0),
...
@pytest.mark.parametrize("filename, expected_enthalpy, scale", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.057653, 1.0),
    ...
    ('13_formaldehyde_tddft_s1.log', -114.186222, 1.0),
    ('15_methanol_oniom_qmmm.log', -40.523659, 1.0),
    ('16_o2_superoxide_anion.log', -150.398316, 1.0),
    ('17_iron_complex_quintet.log', -1828.818094, 1.0),
    ('18_propane_linked_composite_dh.log', -119.025665, 1.0),
    ('19_acetic_acid_smd_dmso.log', -229.111788, 1.0),
    ('21_naphthalene_pm7_semiempirical.log', 0.617009, 1.0),
    ('22_hcn_linear_freq_noraman.log', -93.394316, 1.0),
    ('24_iodobenzene_genecp_sdd.log', -243.046767, 1.0),
    ('25_pd_complex_genecp_def2.log', -969.621290, 1.0),
    ('26_pt_complex_genecp_3zone.log', -1563.529241, 1.0),
    ('27_custom_functional_iop_b20lyp.log', -79.695145, 1.0),
    ('28_pyridine_smd_acetonitrile_wb97xd.log', -248.172568, 1.0),
    ('29_aniline_cpcm_chloroform.log', -249.045341, 1.0),
    ('30_phenol_smd_thf_pbe0_d3bj.log', -307.098559, 1.0),
    ('31_methylammonium_cpcm_water.log', -96.185969, 1.0),
    ('32_cyclohexane_tpss_meta_gga.log', -235.844194, 1.0),
    ('33_methanol_pbepbe_gga.log', -115.556045, 1.0),
    ...
    ('38_naphthalene_scsmp2.log', -389.170904, 1.0),
    ('39_oxazole_tpssh_cpcm_dcm.log', -246.094129, 1.0),
    ('41_thiophene_freq_noraman_nmr.log', -552.973020, 1.0),
    ('42_dmso_linked_cpcm_gasfreq.log', -553.108731, 1.0),
    ('43_dmabn_bhandhlyp_chargetransfer.log', -456.827038, 1.0),
    ...
    ('47_ts_e2_elimination_ethylchloride.log', -615.255026, 1.0),
    ('48_ts_nh3_umbrella_inversion.log', -56.370273, 1.0),
    ('49_ts_oh_abstraction_methane.log', -116.210206, 1.0),
    ('51_err_scf_convergence_fe_complex.log', -2096.663117, 1.0),
    ('58_err_linear_bend_formBX.log', -115.797090, 1.0),
    ('59_err_basis_linear_dependency.log', -7.980777, 1.0),
...
@pytest.mark.parametrize("filename, expected_gibbs, scale", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.100063, 1.0),
    ...
    ('13_formaldehyde_tddft_s1.log', -114.211268, 1.0),
    ('15_methanol_oniom_qmmm.log', -40.550918, 1.0),
    ('16_o2_superoxide_anion.log', -150.421430, 1.0),
    ('17_iron_complex_quintet.log', -1828.881483, 1.0),
    ('18_propane_linked_composite_dh.log', -119.054992, 1.0),
    ('19_acetic_acid_smd_dmso.log', -229.142573, 1.0),
    ('21_naphthalene_pm7_semiempirical.log', 0.573406, 1.0),
    ('22_hcn_linear_freq_noraman.log', -93.417134, 1.0),
    ('24_iodobenzene_genecp_sdd.log', -243.084711, 1.0),
    ('25_pd_complex_genecp_def2.log', -969.672891, 1.0),
    ('26_pt_complex_genecp_3zone.log', -1563.576131, 1.0),
    ('27_custom_functional_iop_b20lyp.log', -79.720864, 1.0),
    ('28_pyridine_smd_acetonitrile_wb97xd.log', -248.204492, 1.0),
    ('29_aniline_cpcm_chloroform.log', -249.079272, 1.0),
    ('30_phenol_smd_thf_pbe0_d3bj.log', -307.133445, 1.0),
    ('31_methylammonium_cpcm_water.log', -96.213477, 1.0),
    ('32_cyclohexane_tpss_meta_gga.log', -235.879243, 1.0),
    ('33_methanol_pbepbe_gga.log', -115.582482, 1.0),
    ...
    ('38_naphthalene_scsmp2.log', -389.206194, 1.0),
    ('39_oxazole_tpssh_cpcm_dcm.log', -246.124815, 1.0),
    ('41_thiophene_freq_noraman_nmr.log', -553.004545, 1.0),
    ('42_dmso_linked_cpcm_gasfreq.log', -553.140977, 1.0),
    ('43_dmabn_bhandhlyp_chargetransfer.log', -456.871335, 1.0),
    ...
    ('47_ts_e2_elimination_ethylchloride.log', -615.293194, 1.0),
    ('48_ts_nh3_umbrella_inversion.log', -56.392409, 1.0),
    ('49_ts_oh_abstraction_methane.log', -116.244649, 1.0),
    ('51_err_scf_convergence_fe_complex.log', -2096.710069, 1.0),
    ('58_err_linear_bend_formBX.log', -115.825658, 1.0),
    ('59_err_basis_linear_dependency.log', -8.000171, 1.0),
...
@pytest.mark.parametrize("filename, E, ZPE, H, TS, TqhS, G, qhG", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.145434, 0.078728, -193.057653, 0.04241, 0.040222, -193.100063, -193.097875),
    ...
    ('17_iron_complex_quintet.log', -1828.869232, 0.034864, -1828.818094, 0.06339, 0.059694, -1828.881483, -1828.877788),
    ...
    ('29_aniline_cpcm_chloroform.log', -249.149756, 0.098079, -249.045341, 0.03393, 0.033937, -249.079272, -249.079279),
...
@pytest.mark.parametrize("filename, E, ZPE, H, TS, TqhS, G, qhG", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.145434, 0.078728, -193.057653, 0.04241, 0.039577, -193.100063, -193.09723),
    ...
    ('10_formaldehyde_verbose_pop.log', -114.462989, 0.02699, -114.43219, 0.024813, 0.024813, -114.457002, -114.457002),
    ('17_iron_complex_quintet.log', -1828.869232, 0.034864, -1828.818094, 0.06339, 0.059203, -1828.881483, -1828.877297),
...
@pytest.mark.parametrize("filename, E, ZPE, H, qhH, TS, TqhS, G, qhG", [
    ...
    ('03_acetone_linked_opt_freq.log', -193.145434, 0.078728, -193.057653, -193.059156, 0.04241, 0.040222, -193.100063, -193.099379),
    ('05_methylene_triplet_carbene.log', -39.019781, 0.017752, -38.998232, -38.998232, 0.022228, 0.022228, -39.02046, -39.02046),
    ('17_iron_complex_quintet.log', -1828.869232, 0.034864, -1828.818094, -1828.82139, 0.06339, 0.059694, -1828.881483, -1828.881083),
...
@pytest.mark.parametrize("filename, E, ZPE, G, qhG, num_imag", [
    ...
    ('47_ts_e2_elimination_ethylchloride.log', -615.338128, 0.075555, -615.293194, -615.292811, 1),
    ('48_ts_nh3_umbrella_inversion.log', -56.407377, 0.03332, -56.392409, -56.392409, 1),
    ('49_ts_oh_abstraction_methane.log', -116.270515, 0.053403, -116.244649, -116.244445, 1),
])
...
@pytest.mark.parametrize("filename, expected_nfreqs", [
    ...
    ('18_propane_linked_composite_dh.log', 25),
    ('42_dmso_linked_cpcm_gasfreq.log', 21),
])
